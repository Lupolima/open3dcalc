      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-lg glass text-gray-400 hover:text-white transition-colors"
          >
          ...
          <button
            ...
            className="text-xs font-semibold px-3 py-1.5 rounded-lg glass text-gray-300 hover:text-white hover:bg-white/10 transition-colors min-w-[44px]"
          >
