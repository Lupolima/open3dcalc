      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 h-[61px] flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="leading-none">
            <div className="flex items-center gap-2">
              <h1 className="text-[15px] font-black tracking-tight gradient-text">
                {t('app.title')}
              </h1>
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="p-2 lg:p-2.5 text-slate-400 hover:text-white hover:bg-white/5 rounded-xl transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            title="GitHub"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-[13px] font-semibold px-3 py-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-white/[0.05] transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none min-w-[44px]"
            title="Mudar idioma"
          >
