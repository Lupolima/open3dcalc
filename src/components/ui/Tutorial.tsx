    ...
    <FloatingPortal>
      ...
      >
        ...
        >
          ...
          <button
            onClick={onFinish}
            className="absolute top-2.5 right-2.5 z-10 p-1 rounded-lg text-gray-500 hover:text-gray-200 hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
          ...
          <div className="px-5 pt-5 pb-4">
            <h3 className="text-lg font-bold text-white mb-1.5 pr-6">
          ...
          <div className="px-5 pb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              {!isFirst && (
                <button
                  onClick={onPrevious}
                  className="p-1.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
              ...
              {!isLast && (
                <button
                  onClick={onSkip}
                  className="px-2.5 py-1 rounded-lg text-[11px] font-medium text-gray-500 hover:text-gray-300 hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                >
                  {t('tutorial.skip')}
                </button>
              )}
              ...
              {isLast ? (
                <button
                  onClick={onFinish}
                  className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-semibold bg-indigo-600 text-white hover:bg-indigo-500 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                >
                  {t('tutorial.finish')}
