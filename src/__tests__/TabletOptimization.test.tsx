...
vi.mock('@/components/Catalog/CatalogTab', () => ({
  CatalogTab: () => <div>CatalogTab</div>,
}))
vi.mock('@/components/Calculator/HistoryTab/HistoryTab', () => ({
  HistoryTab: () => <div>HistoryTab</div>,
}))
vi.mock('@/components/Dashboard/Dashboard', () => ({
  Dashboard: () => <div>Dashboard</div>,
}))
vi.mock('@/components/Changelog/ChangelogPage', () => ({
  ChangelogPage: () => <div>ChangelogPage</div>,
}))
vi.mock('@/components/Calculator/InfillCalculator', () => ({
  InfillCalculator: () => <div>InfillCalculator</div>,
}))
vi.mock('@/components/Catalog/FilamentInventory', () => ({
