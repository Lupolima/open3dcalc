...
export const DEFAULT_FDM_PARAMS: PrintParameters = { printTimeHours: 5, printerPowerWatts: 250, energyCostPerKwh: 0.80, failureMode: 'percent', failureValue: 10, riskMultiplier: 1 }
...
export const DEFAULT_OPS: OperationalCosts = { enabled: false, ppeCostPerPrint: 0 }
export const DEFAULT_SOFT: SoftwareCosts = { enabled: false, slicerMonthlyCost: 0, modelFileCost: 0 }
export const DEFAULT_SALES: SalesParameters = { packagingCost: 2, shippingCost: 0, taxPercent: 0, marketplaceFeePercent: 0, profitMarginPercent: 50 }
...
export const DEFAULT_RESIN_PARAMS: PrintParameters = { printTimeHours: 2, printerPowerWatts: 50, energyCostPerKwh: 0.80, failureMode: 'none', failureValue: 0, riskMultiplier: 1 }
...
export const DEFAULT_RESIN_OPS: OperationalCosts = { enabled: true, ppeCostPerPrint: 2.50 }
...
export const DEFAULT_RESIN_SALES: SalesParameters = { packagingCost: 2, shippingCost: 0, taxPercent: 0, marketplaceFeePercent: 0, profitMarginPercent: 50 }
