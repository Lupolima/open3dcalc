    ...
    <div className="space-y-5">
      <div className="surface rounded-xl p-5 flex flex-wrap gap-3 items-center justify-between">
        ...
        <div className="flex gap-2 text-xs">
          <span className="px-3 py-1.5 rounded-[6px] bg-[var(--color-bg-elevated)] border border-[var(--color-border)] text-[var(--color-text-secondary)]">{stats.printers} {t('catalog.printers')}</span>
          <span className="px-3 py-1.5 rounded-[6px] bg-[var(--color-bg-elevated)] border border-[var(--color-border)] text-[var(--color-text-secondary)]">{stats.materials} {t('catalog.materials')}</span>
          <span className="px-3 py-1.5 rounded-[6px] bg-[var(--color-bg-elevated)] border border-[var(--color-border)] text-[var(--color-text-secondary)]">{stats.marketplaces} {t('catalog.marketplaces')}</span>
        </div>
      </div>

      <div className="surface rounded-xl p-2 flex gap-2" role="tablist" aria-label={t('catalog.title')}>
        <button
          role="tab"
