...
1. Leia o [README](README.md) e o [ROADMAP](ROADMAP.md) para entender o estado atual
...
│   │   └── ui/         # Componentes reutilizáveis (ConfirmDialog, etc.)
│   ├── stores/         # Zustand stores (estado global)
│   ├── lib/            # Lógica de cálculo, parsers, export
