...
export function PrivacyPolicy({ open, onClose }: PrivacyPolicyProps) {
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className="glass rounded-2xl p-6 w-full max-w-2xl max-h-[85vh] overflow-y-auto animate-fade-in"
      ...
      >
        ...
        {/* Content */}
        <div className="space-y-5 text-sm text-slate-400 leading-relaxed pr-1">
