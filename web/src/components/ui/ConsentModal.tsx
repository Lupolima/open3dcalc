        ...
        {!showPolicy ? (
          <>
            ...
            <div className="space-y-3 mb-6">
              ...
              <ol className="space-y-2 text-sm text-slate-400 list-decimal list-inside leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row-reverse gap-3">
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-sm font-semibold bg-indigo-600 text-white hover:bg-indigo-500 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
              >
                {t('privacy.consent.accept')}
              </button>
              <button
                onClick={() => setShowPolicy(true)}
                className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-sm text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
              >
...
function PrivacyPolicyContent({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="space-y-4 text-sm text-slate-400 leading-relaxed max-h-[50vh] overflow-y-auto pr-1">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-base font-bold text-slate-100">{t('privacy.policy.title')}</h3>
        <button
          onClick={onBack}
          className="text-slate-500 hover:text-slate-300 p-1 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none text-xs"
        >
