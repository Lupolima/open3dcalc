...
import { QuoteDoc } from '@/lib/QuoteDoc'
import type { Quote, QuoteItem, QuoteFormData, Customer } from '@/types'
import {
...
const STATUS_CONFIG: Record<Quote['status'], { label: string; color: string; bg: string }> = {
  draft:    { label: 'Rascunho',  color: 'text-gray-400',  bg: 'bg-gray-500/20' },
...
function Modal({
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className={`glass rounded-2xl max-h-[90vh] overflow-y-auto animate-fade-in ${
          wide ? 'w-[95%] max-w-3xl' : 'w-[90%] max-w-lg'
        }`}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between p-5 pb-3 border-b border-white/10 sticky top-0 bg-[#0f0b1e]/90 backdrop-blur-md z-10 rounded-t-2xl">
          <h2 className="text-lg font-bold gradient-text">{title}</h2>
          <button
            ref={closeRef}
            onClick={onClose}
            className="text-gray-400 hover:text-white p-1.5 rounded-lg transition-colors hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
            aria-label="Fechar"
          >
            <X className="w-5 h-5" />
          </button>
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-white/[0.04] border border-white/10 hover:border-white/20 rounded-xl text-sm text-white h-11 px-3 placeholder:text-gray-400/70 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500/60 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-white/[0.04] border border-white/10 hover:border-white/20 rounded-xl text-sm text-white h-11 px-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500/60 transition-all appearance-none cursor-pointer"
          >
            <option value="" className="bg-gray-900">Selecionar cliente</option>
            {customers.map((c) => (
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-indigo-600/30 text-indigo-300 hover:bg-indigo-600/50 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none flex items-center gap-1.5"
            >
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="flex flex-col items-center">
                      <span className="text-[9px] text-gray-500 uppercase">Qtd</span>
                      <input
                        type="number"
                        min={1}
                        value={item.quantity}
                        onChange={(e) => updateItem(idx, 'quantity', e.target.value)}
                        className="w-14 bg-white/[0.04] border border-white/10 rounded-lg text-sm text-white h-8 px-2 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                      />
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-[9px] text-gray-500 uppercase">V.Unit</span>
                      <input
                        type="number"
                        min={0}
                        step={0.01}
                        ...
                        className="w-20 bg-white/[0.04] border border-white/10 rounded-lg text-sm text-white h-8 px-2 text-center focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
                      />
                    </div>
                    <div className="flex flex-col items-center">
                      <span className="text-[9px] text-gray-500 uppercase">Desc%</span>
                      <input
                        type="number"
                        min={0}
                        max={100}
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-lg text-red-400 hover:bg-red-500/20 transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/10 hover:border-white/20 rounded-xl text-sm text-white h-11 px-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
            />
          </div>
          <div>
            <label className="text-[11px] font-semibold uppercase tracking-wider text-gray-500 block mb-1.5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white/[0.04] border border-white/10 hover:border-white/20 rounded-xl text-sm text-white h-11 px-3 placeholder:text-gray-400/70 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all"
            />
          </div>
          <div>
            <label className="text-[11px] font-semibold uppercase tracking-wider text-gray-500 block mb-1.5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full bg-white/[0.04] border border-white/10 hover:border-white/20 rounded-xl text-sm text-white px-3 py-2 placeholder:text-gray-400/70 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all resize-none"
          />
        </div>
        ...
        <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="text-white font-mono">{symbol} {formatPrice(subtotal)}</span>
          </div>
          {globalDiscount > 0 && (
            <div className="flex justify-between items-center text-sm mt-1">
              <span className="text-red-400">Desconto ({globalDiscount}%)</span>
              <span className="text-red-400 font-mono">-{symbol} {formatPrice(discountAmount)}</span>
            </div>
          )}
          <div className="flex justify-between items-center text-base font-bold mt-3 pt-3 border-t border-white/10">
            <span className="text-white">TOTAL</span>
            <span className="text-emerald-400 font-mono text-lg">{symbol} {formatPrice(total)}</span>
          </div>
        </div>
        ...
        <div className="flex gap-3 pt-2">
          <button
            onClick={onClose}
            className="flex-1 py-3 rounded-xl text-sm bg-white/5 text-gray-300 hover:bg-white/10 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
          >
            Cancelar
          </button>
          <button
            onClick={handleSave}
            className="flex-1 py-3 rounded-xl text-sm font-semibold bg-indigo-600 text-white hover:bg-indigo-500 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none flex items-center justify-center gap-2"
          >
          ...
          {historyEntries.length === 0 ? (
            ...
            historyEntries.map((entry) => (
              <button
                ...
                className="w-full text-left p-3 rounded-xl bg-white/[0.03] hover:bg-white/[0.06] border border-white/10 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
              >
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="bg-white/[0.04] border border-white/10 rounded-lg text-xs text-white h-8 px-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all appearance-none cursor-pointer"
            >
              <option value="draft" className="bg-gray-900">Rascunho</option>
              <option value="sent" className="bg-gray-900">Enviado</option>
              <option value="approved" className="bg-gray-900">Aprovado</option>
              <option value="rejected" className="bg-gray-900">Recusado</option>
            </select>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Título</p>
            <p className="text-sm text-white font-medium">{quote.title}</p>
          </div>
          {quote.validUntil && (
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Validade</p>
              <p className="text-sm text-white">{new Date(quote.validUntil + 'T00:00:00').toLocaleDateString('pt-BR')}</p>
            </div>
          )}
        </div>
        ...
        {quote.items.length > 0 && (
          <div>
            <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Itens</p>
                  ...
                  {quote.items.map((item, idx) => {
                    ...
                    return (
                      <tr key={idx} className="border-b border-white/5">
                        <td className="py-2.5 pr-2 text-white">{item.quantity}</td>
                        <td className="py-2.5 px-2 text-white">
                          {item.name}
                          {item.discountPercent > 0 && (
                            <span className="text-red-400 text-xs ml-1">(-{item.discountPercent}%)</span>
                          )}
                        </td>
                        <td className="py-2.5 px-2 text-right text-gray-300 font-mono">
                          {formatMoney(item.unitPrice)}
                        </td>
                        <td className="py-2.5 pl-2 text-right text-white font-mono font-medium">
        ...
        {/* Totals */}
        <div className="rounded-xl bg-white/[0.04] border border-white/10 p-4 max-w-xs ml-auto">
          <div className="flex justify-between text-sm">
            <span className="text-gray-400">Subtotal</span>
            <span className="text-white font-mono">{formatMoney(quote.subtotal)}</span>
          </div>
          {quote.globalDiscountPercent > 0 && (
            <div className="flex justify-between text-sm mt-1">
              <span className="text-red-400">Desconto ({quote.globalDiscountPercent}%)</span>
              <span className="text-red-400 font-mono">-{formatMoney(quote.discountAmount)}</span>
            </div>
          )}
          <div className="flex justify-between text-base font-bold mt-3 pt-3 border-t border-white/10">
            <span className="text-white">TOTAL</span>
            <span className="text-emerald-400 font-mono text-lg">{formatMoney(quote.total)}</span>
          </div>
        </div>
        ...
        {(quote.paymentTerms || quote.deliveryEstimate || quote.footerNote) && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            ...
            {quote.deliveryEstimate && (
              <div>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Prazo</p>
                <p className="text-white">{quote.deliveryEstimate}</p>
              </div>
            )}
            {quote.footerNote && (
              <div className="sm:col-span-2">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Observações</p>
                <p className="text-white italic">{quote.footerNote}</p>
              </div>
            )}
          </div>
        )}
    ...
    <div className="glass rounded-2xl p-5 animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-4 border-b border-white/10 pb-2">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl text-xs font-semibold bg-indigo-600 text-white hover:bg-indigo-500 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none flex items-center gap-1.5"
        >
      ...
      {filtered.length === 0 ? (
        <div className="text-center py-12">
          ...
          <button
            onClick={handleNewQuote}
            className="mt-3 px-4 py-2 rounded-xl text-xs font-semibold bg-indigo-600/50 text-indigo-300 hover:bg-indigo-600/70 transition-colors"
          >
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    ...
                    className="p-2 rounded-lg text-gray-400 hover:text-indigo-300 hover:bg-indigo-500/20 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-gray-400 hover:text-amber-300 hover:bg-amber-500/20 transition-colors focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none"
                    aria-label="Editar"
                    title="Editar"
                  >
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg text-gray-400 hover:text-red-400 hover:bg-red-500/20 transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
                    aria-label="Excluir"
                    title="Excluir"
                  >
                    <Trash2 className="w-3.5 h-3.5" />
