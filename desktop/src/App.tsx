  ...
  return (
    <div className="min-h-dvh flex flex-col">
      ...
      <nav
        ...
        style={{ background: 'var(--color-bg-primary)', backdropFilter: 'blur(20px)', borderTop: '1px solid rgba(255,255,255,0.07)', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}
      ...
      <footer className="hidden lg:block text-center text-xs text-[var(--color-text-muted)] py-3 border-t border-white/[0.04]">
        <div className="flex items-center justify-center gap-3">
          <a
            href="https://github.com/ils15/open3dcalc"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-[var(--color-text-secondary)] transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none px-1 rounded"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-[var(--color-text-muted)] hover:text-[var(--color-text-secondary)] transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none px-1 rounded"
          >
            ofertachina.com.br
          </a>
        </div>
