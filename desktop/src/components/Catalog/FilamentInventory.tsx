    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={openAdd}
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold bg-[var(--color-accent)] text-white hover:bg-[var(--color-accent-hover)] active:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/20"
          >
      ...
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        {filtered.map(s => {
          ...
          return (
            <div
              key={s.id}
              className="surface rounded-2xl p-4 group relative flex flex-col gap-3 hover:shadow-xl transition-shadow"
            >
              {isLow && (
        ...
        {filtered.length === 0 && (
          <div className="col-span-full surface rounded-2xl p-12 text-center text-[var(--color-text-muted)] text-sm">
      ...
      {showPalette && (
        ...
        >
          <div
            className="surface rounded-2xl p-6 w-full max-w-md max-h-[80vh] overflow-y-auto"
            onClick={e => e.stopPropagation()}
          >
            <div className="flex items-center justify-between mb-5">
