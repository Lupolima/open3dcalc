...
function Modal({
  ...
  return (
    ...
    >
      <div
        ref={dialogRef}
        className={`surface rounded-2xl max-h-[90vh] overflow-y-auto animate-fade-in ${
          wide ? 'w-[95%] max-w-3xl' : 'w-[90%] max-w-lg'
        }`}
        onClick={(e) => e.stopPropagation()}
      >
        <div className="flex items-center justify-between p-5 pb-3 border-b border-[var(--color-border)] sticky top-0 bg-[var(--color-bg-primary)]/90 backdrop-blur-md z-10 rounded-t-2xl">
...
export function QuoteSection() {
  ...
  return (
    <div className="surface rounded-2xl p-5 animate-fade-in">
      {/* Header */}
