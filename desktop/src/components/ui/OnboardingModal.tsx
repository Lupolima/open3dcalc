      ...
      >
        ...
        <div className="px-6 pb-6 flex items-center justify-between">
          ...
          {isLastSlide ? (
            <button
              onClick={dismiss}
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-[var(--color-accent)] text-[var(--color-text-primary)] hover:bg-indigo-500 transition-colors focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:outline-none"
            >
              {t('onboarding.start')}
