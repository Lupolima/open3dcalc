    ...
    >
      <div className="max-w-[1440px] mx-auto flex items-start gap-3 px-4 sm:px-6 py-3">
        ...
        <button
          ...
          className="shrink-0 p-1.5 rounded-lg text-[var(--color-text-muted)] hover:text-white hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none"
