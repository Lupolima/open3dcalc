        ...
        <div className="space-y-1">
          {comparisonFields.map(field => {
            ...
            return (
              <div
                key={field.key}
                className="grid grid-cols-1 min-[400px]:grid-cols-[1fr_1fr_1fr] gap-2 min-[400px]:gap-3 py-2.5 px-2 rounded-xl border-b border-white/5 last:border-b-0 hover:bg-[var(--color-bg-hover)] transition-colors text-sm"
              >
