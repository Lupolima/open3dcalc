    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="z-50 w-full mt-1.5 glass border border-[var(--color-border)] rounded-xl shadow-2xl overflow-hidden"
